...
<div class="container-fluid w-100 row maincont">
        ...
        <form action="../db/addadmin.php" method="POST">
        <div class="mb-2">
        ...
        <p class="text-center my-2">Already have an account ? <a href="../admin/adminlogin.php" style="text-decoration: none; color:cyan;">Login in</a> </p>
    </div>
